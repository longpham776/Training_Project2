...
class Mst_model_maker extends Model
{
    ...
    public function scopeMakerName($query, $column)
    {
        return $query->selectRaw(
            ...
            ->where($column, 1)
            ->whereIn('v2.model_maker_code', tbl_category_maker::makerCode(1, 1))->groupBy('model_maker_code')->orderBy('model_maker_select_view_no');
    }
}
